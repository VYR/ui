...
@Component({
    selector: 'app-cib-input-matcher',
    templateUrl: './cib-input-matcher.component.html',
    styleUrls: ['./cib-input-matcher.component.scss'],
})
export class CibInputMatcherComponent implements OnChanges {
