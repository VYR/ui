...
import { CIBTableQuery, CIBTableConfig, CIBTableColumn, ColumnType, SortDirection } from './models/config.model';
import { MatSlideToggleChange } from '@angular/material/slide-toggle';
@Component({
    selector: 'app-cib-table',
    templateUrl: './cib-table.component.html',
    styleUrls: ['./cib-table.component.scss'],
})
export class CibTableComponent implements OnChanges, AfterViewInit {
    @ViewChild(MatTable) table!: MatTable<any>;
    @ViewChild(MatPaginator) paginator!: MatPaginator;
    @ViewChild(MatSort) sort!: MatSort;
    @Input() config: CIBTableConfig = new CIBTableConfig();
    @Output() _lazyLoad: EventEmitter<CIBTableQuery> = new EventEmitter<CIBTableQuery>();
    ...
    columnDefs: Array<CIBTableColumn> = [];
    columns: Array<String> = [];
    dataSource = new MatTableDataSource<any>([]);
    query: CIBTableQuery = new CIBTableQuery();
