...
@Component({
    selector: 'app-cib-pie-chart',
    templateUrl: './cib-pie-chart.component.html',
    styleUrls: ['./cib-pie-chart.component.scss'],
})
export class CibPieChartComponent implements DoCheck, AfterViewInit {
