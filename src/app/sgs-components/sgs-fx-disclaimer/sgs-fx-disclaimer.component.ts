...
@Component({
    selector: 'app-sgs-fx-disclaimer',
    templateUrl: './sgs-fx-disclaimer.component.html',
    styleUrls: ['./sgs-fx-disclaimer.component.scss'],
})
export class SgsFxDisclaimerComponent implements OnInit {
